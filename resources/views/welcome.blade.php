            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 d-inline-flex p-2" role="search " >
                    ...
                    <input class="form-control me-2 d-inline-flex p-2" type="search" placeholder="Search Medicine"
                        aria-label="Search">
                    <button class="btn btn-outline-danger me-1 text-light" style="background-color: #0e313a;"
                ...
                <a href="./cart">
                    <img src="./images/Cart.png" width="35px" style="margin-left:15px; cursor:pointer;" id="cartStatus" id="myPopup" onClick="myFunction()">
                </a>
            </div>
        </div>
        ...
        <div class="ProductList2">
            ...
            <div class="card">
                ...
                <div class="card-body d-flex flex-column align-item-center justify-content-center">
                    ...
                    <form action="{{url('cart',$medicine->id)}}" method="post">
                        @csrf

                        <div class="qtyPriceDiv">
                            <h5> {{ $medicine->medicinePrice}}</h5>

                            <input class="numberInput form-control" type="number" name="Quantity" value="1" min="1"
